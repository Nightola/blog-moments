...
const qnaData = [
    ...
    {q: "为什么会喜欢夜晚？", a: "很久以前，感觉夜晚很浪漫，能看到很多星星。如果可以，没准和喜欢的人在夜色之下有段美好的回忆。以前总是在晚上偷偷用mp3听歌，被新颖旋律冲击的感觉让我感觉夜晚很美好。只是现在好像对夜晚丧失了滤镜，但我依然喜欢自由支配、不被打扰的时光。", time: "2025-12-13 03:05"},
...
async function init() {
    try {
        ...
        renderYearBtns();
        setMode('home'); // 确保初始进入首页并触发同步
    } catch (e) { console.error("Data error"); }
}

function setMode(mode) {
    currentMode = mode;
    clearObsStation(); // 清除之前的定时器和监听
